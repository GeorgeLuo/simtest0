...
- The Implementation Guidelines to separate files with each sub-topic of the section as part of the filename as above
...
│   ├── <this document's file name>_<name of section of implementation guidelines>.md*
│   └── index.md
├── tools/
│   └── index.md
├── workspaces/
