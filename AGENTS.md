...
- `instruction_documents/Describing_Simulation_0_simeval_master_prompt_important.md` to confirm the mindset roster (tasker, implementer, integrator, aligner, optimizer) before acting.
